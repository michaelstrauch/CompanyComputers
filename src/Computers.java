public class Computers {
    ...
    public Computers(String model, int diagonalOfMonitor, boolean isCompanyComputer, double price, String typeOfComputer) {
        this.model = model;
    ...
    public Computers(int diagonalOfMonitor, double price, String typeOfComputer) {
